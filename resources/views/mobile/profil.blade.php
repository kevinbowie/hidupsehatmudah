  ...
  <table class="table table-hover">
    <tbody>
        ...
        <td>
          <div class="form-group">
            <div class="col-sm-9">
              ...
              <a href="{{ url('mobile/profil/gantipassword') }}" class="btn btn-default">UBAH</a>
            </div>
          </div>
        </td>
      </tr>
      ...
      <tr class="text-center">
        <td colspan="2"><button type="button" class="btn btn-default edit" data-toggle='modal' data-target='#edit-modal'>Ubah Profil</button></td>
      </tr>
    </tbody>
  </table>
</div>
