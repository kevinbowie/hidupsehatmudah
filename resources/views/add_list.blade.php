			...
			echo "<div class='panel panel-default'>
				...
				<div id='yours" . $index . "' class='panel-collapse collapse'>
					<div class='panel-body'>
						...
						$ssql2 = "SELECT a.list_id, b.title, b.protein, b.fat, b.carbohydrate 
								 FROM menu_dtl a inner join calories_list_dtl b on a.list_id = b.id
								 where a.menu_id = " . $hdr['id'] . ";";
						$result2 = mysqli_query($connection->myconn, $ssql2);
						while ($dtl=mysqli_fetch_array($result2)){
							$cal = $dtl['carbohydrate'] + $dtl['protein'] + $dtl['fat'];
							echo "<li>
								<input type='checkbox' name='calId[]' value='" . $dtl['list_id'] . "'> " . $dtl['title'] . "<span style='float:right;'>" . $cal . " | " . $dtl['fat'] . " | " . $dtl['protein'] . " | " . $dtl['carbohydrate'] . "</span></li>";
							$totalCal += $cal;
							$totalLip += $dtl['fat'];
...
function setTotal($totalCal, $totalLip, $totalPro, $totalCarb){ ?>
	<script type="text/javascript">
		...
		loc.append("<span style='float:right;'>Calorie: <?php echo $totalCal; ?> | Lipid: <?php echo $totalLip; ?> | Protein: <?php echo $totalPro; ?> | Carbohydrate: <?php echo $totalCarb; ?></span>");
	</script> <?php
}
?>
						...
						<div class="modal-header">
							...
							<div class="page-header"><h2 class="text-center">Atur Porsi</h2></div>	
								...
								<div class="form-group col-sm-6">
									<label for="Category">Porsi</label>
			    ...
			    <div class="modal-dialog modal-sm">
						...
						<div class="modal-header">
							...
							<div class="page-header"><h2 class="text-center">Atur Pengingat</h2></div>	
					  		<input type="hidden" name="catId" value="">
							<input type="hidden" name="date" value="">
							<div class="form-group bootstrap-timepicker timepicker col-sm-6">
