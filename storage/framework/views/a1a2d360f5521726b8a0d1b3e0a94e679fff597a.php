...
<?php if(Session::has('messages')): ?>
	<div class='alert alert-info'><?php echo e(Session::get('messages')); ?></div>
<?php endif; ?>
<div class="container">
		<h2>Tahukah anda ?</h2>
...
<br>
<?php echo $__env->make('navbar/navbar_footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
</body>
</html>