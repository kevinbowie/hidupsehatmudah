  	...
  	<div class="modal-dialog">
    	<div class="modal-content">
      		...
      		<div id="div-forms">
      			...
      			<?php echo Form::open(['method' => 'POST', 'action' => 'CRUDController@login', 'id' => 'login-form']); ?>

	      			<div class="modal-body">
	      				<div id="div-login-msg">
	      					<div id="icon-login-msg" class="glyphicon glyphicon-chevron-right"></div>
	      					<span id="text-login-msg">
	      						<?php if(Session::has('msglogin')): ?>
									<?php echo e(Session::get('msglogin')); ?>
	      				...
	      				<div class="form-group">
	      					<div class="input-group">
			      				...
			      				<input id="login_username" class="form-control" name="username" placeholder="Username" required="required" type="text" value="<?php echo e(old('username')); ?>"></input>
							</div>
